...
const CartCount = ({ onCartToggle, totalQTY,  onClearCartItems}) => {
  return (
    ...
    <div className='bg-white h-11 flex items-center justify-between px-3 
    sticky top-0 left-0 right-0 w-full'>
      <div className='flex items-center gap-3'>
        ...
        <div>
           ...
           <span
           className='bg-theme-cart rounded px-1 py-0.5 text-slate-100 font-normal text-xs'>{totalQTY}(Items)</span></h1>
        </div>
      </div>
      <div>
