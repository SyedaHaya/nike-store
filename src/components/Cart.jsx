...
const Cart = () => {
  ...
  //console.log("ifCartState", ifCartState);
  ...
  return (
    ...
    right-0 bottom-0 blur-effect-theme w-full h-screen opacity-100 z-[250]
    ${
      CartState
      ...
      >
        ...
        >
          ...
          {CartItems?.length === 0 ? (
            ...
            <div>
              <div
                className="flex items-start justify-start flex-col gap-y-7 
              ...
              <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
                ...
                <div className="grid items-center gap-2">
                  <p className="text-sm font-medium text-center">
                    Taxes and Shipping Will Calculate At Shiping
                  </p>
                  <button
                    type="button"
